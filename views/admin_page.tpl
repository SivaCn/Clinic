<html>
   <head>
      <link rel="stylesheet" type="text/css" href="page_front.css">
   </head>
<form>
  <body>
    <div id="mainContainer">
       <div id="header">
           <img src="http://i.imgur.com/h1JLm9A.jpg"/ height="30%">
       </div> <!-- end header -->
...
<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
    ...
    <div id="footer">
        <p align="right">Copyright © 2008 by Clinic, LLC. All Rights Reserved.</p>
    </div>
</body>
</form>
</html>
